...
Version  : 1.7.1
Release  : 30
URL      : https://github.com/cronie-crond/cronie/archive/cronie-1.7.1/cronie-1.7.1.tar.gz
Source0  : https://github.com/cronie-crond/cronie/archive/cronie-1.7.1/cronie-1.7.1.tar.gz
...
%prep
%setup -q -n cronie-cronie-1.7.1
cd %{_builddir}/cronie-cronie-1.7.1
%patch -P 1 -p1
pushd ..
cp -a cronie-cronie-1.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705071985

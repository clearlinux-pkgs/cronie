...
Version  : 1.6.0
Release  : 26
URL      : https://github.com/cronie-crond/cronie/archive/cronie-1.6.0/cronie-1.6.0.tar.gz
Source0  : https://github.com/cronie-crond/cronie/archive/cronie-1.6.0/cronie-1.6.0.tar.gz
...
%prep
%setup -q -n cronie-cronie-1.6.0
cd %{_builddir}/cronie-cronie-1.6.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647985142
...
cp %{_builddir}/cronie-cronie-1.6.0/COPYING %{buildroot}/usr/share/package-licenses/cronie/6261e3b944ea705753eeb12c7e6fb0ef3ba42bee
cp %{_builddir}/cronie-cronie-1.6.0/COPYING.anacron %{buildroot}/usr/share/package-licenses/cronie/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/cronie-cronie-1.6.0/COPYING.obstack %{buildroot}/usr/share/package-licenses/cronie/9a1929f4700d2407c70b507b3b2aaf6226a9543c
%make_install
